...
func (m *MockINotificationPushService) NewApproveRentingCarRequestMsg(expoToken, toPhone string) *PushMessage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewApproveRentingCarRequestMsg", expoToken, toPhone)
	ret0, _ := ret[0].(*PushMessage)
	return ret0
}

// NewApproveRentingCarRequestMsg indicates an expected call of NewApproveRentingCarRequestMsg.
func (mr *MockINotificationPushServiceMockRecorder) NewApproveRentingCarRequestMsg(expoToken, toPhone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewApproveRentingCarRequestMsg", reflect.TypeOf((*MockINotificationPushService)(nil).NewApproveRentingCarRequestMsg), expoToken, toPhone)
}
...
func (m *MockINotificationPushService) NewReceivingPaymentMsg(month, amount int, expoToken, toPhone string) *PushMessage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewReceivingPaymentMsg", month, amount, expoToken, toPhone)
	ret0, _ := ret[0].(*PushMessage)
	return ret0
}

// NewReceivingPaymentMsg indicates an expected call of NewReceivingPaymentMsg.
func (mr *MockINotificationPushServiceMockRecorder) NewReceivingPaymentMsg(month, amount, expoToken, toPhone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewReceivingPaymentMsg", reflect.TypeOf((*MockINotificationPushService)(nil).NewReceivingPaymentMsg), month, amount, expoToken, toPhone)
}
