...
// NewCarPendingResolve mocks base method.
func (m *MockINotificationPushService) NewCarPendingResolve(carID, contractID int, expoToken, toPhone string) *PushMessage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewCarPendingResolve", carID, contractID, expoToken, toPhone)
	ret0, _ := ret[0].(*PushMessage)
	return ret0
}

// NewCarPendingResolve indicates an expected call of NewCarPendingResolve.
func (mr *MockINotificationPushServiceMockRecorder) NewCarPendingResolve(carID, contractID, expoToken, toPhone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewCarPendingResolve", reflect.TypeOf((*MockINotificationPushService)(nil).NewCarPendingResolve), carID, contractID, expoToken, toPhone)
}

// NewCarResolved mocks base method.
func (m *MockINotificationPushService) NewCarResolved(carID, contractID int, expoToken, toPhone string) *PushMessage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewCarResolved", carID, contractID, expoToken, toPhone)
	ret0, _ := ret[0].(*PushMessage)
	return ret0
}

// NewCarResolved indicates an expected call of NewCarResolved.
func (mr *MockINotificationPushServiceMockRecorder) NewCarResolved(carID, contractID, expoToken, toPhone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewCarResolved", reflect.TypeOf((*MockINotificationPushService)(nil).NewCarResolved), carID, contractID, expoToken, toPhone)
}
...
// NewPartnerApproveCustomerContractMsg mocks base method.
func (m *MockINotificationPushService) NewPartnerApproveCustomerContractMsg(contractID int, expoToken, toPhone string) *PushMessage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewPartnerApproveCustomerContractMsg", contractID, expoToken, toPhone)
	ret0, _ := ret[0].(*PushMessage)
	return ret0
}

// NewPartnerApproveCustomerContractMsg indicates an expected call of NewPartnerApproveCustomerContractMsg.
func (mr *MockINotificationPushServiceMockRecorder) NewPartnerApproveCustomerContractMsg(contractID, expoToken, toPhone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewPartnerApproveCustomerContractMsg", reflect.TypeOf((*MockINotificationPushService)(nil).NewPartnerApproveCustomerContractMsg), contractID, expoToken, toPhone)
}

// NewPartnerReceiveNewRentingRequest mocks base method.
func (m *MockINotificationPushService) NewPartnerReceiveNewRentingRequest(carID, contractID int, expoToken, toPhone string) *PushMessage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewPartnerReceiveNewRentingRequest", carID, contractID, expoToken, toPhone)
	ret0, _ := ret[0].(*PushMessage)
	return ret0
}

// NewPartnerReceiveNewRentingRequest indicates an expected call of NewPartnerReceiveNewRentingRequest.
func (mr *MockINotificationPushServiceMockRecorder) NewPartnerReceiveNewRentingRequest(carID, contractID, expoToken, toPhone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewPartnerReceiveNewRentingRequest", reflect.TypeOf((*MockINotificationPushService)(nil).NewPartnerReceiveNewRentingRequest), carID, contractID, expoToken, toPhone)
}

// NewPartnerRejectCustomerContractMsg mocks base method.
func (m *MockINotificationPushService) NewPartnerRejectCustomerContractMsg(contractID int, expoToken, toPhone string) *PushMessage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewPartnerRejectCustomerContractMsg", contractID, expoToken, toPhone)
	ret0, _ := ret[0].(*PushMessage)
	return ret0
}

// NewPartnerRejectCustomerContractMsg indicates an expected call of NewPartnerRejectCustomerContractMsg.
func (mr *MockINotificationPushServiceMockRecorder) NewPartnerRejectCustomerContractMsg(contractID, expoToken, toPhone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewPartnerRejectCustomerContractMsg", reflect.TypeOf((*MockINotificationPushService)(nil).NewPartnerRejectCustomerContractMsg), contractID, expoToken, toPhone)
}
...
func (m *MockINotificationPushService) NewRejectRentingCarRequestMsg(contractID int, expoToken, toPhone string) *PushMessage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewRejectRentingCarRequestMsg", contractID, expoToken, toPhone)
	ret0, _ := ret[0].(*PushMessage)
	return ret0
}

// NewRejectRentingCarRequestMsg indicates an expected call of NewRejectRentingCarRequestMsg.
func (mr *MockINotificationPushServiceMockRecorder) NewRejectRentingCarRequestMsg(contractID, expoToken, toPhone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewRejectRentingCarRequestMsg", reflect.TypeOf((*MockINotificationPushService)(nil).NewRejectRentingCarRequestMsg), contractID, expoToken, toPhone)
}

// NewRentingContract mocks base method.
func (m *MockINotificationPushService) NewRentingContract(carID, cusContractID int, expoToken, toPhone string) *PushMessage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewRentingContract", carID, cusContractID, expoToken, toPhone)
	ret0, _ := ret[0].(*PushMessage)
	return ret0
}

// NewRentingContract indicates an expected call of NewRentingContract.
func (mr *MockINotificationPushServiceMockRecorder) NewRentingContract(carID, cusContractID, expoToken, toPhone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewRentingContract", reflect.TypeOf((*MockINotificationPushService)(nil).NewRentingContract), carID, cusContractID, expoToken, toPhone)
}

// NewReplaceByCar mocks base method.
func (m *MockINotificationPushService) NewReplaceByCar(carID, cusContractID int, expoToken, toPhone string) *PushMessage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewReplaceByCar", carID, cusContractID, expoToken, toPhone)
	ret0, _ := ret[0].(*PushMessage)
	return ret0
}

// NewReplaceByCar indicates an expected call of NewReplaceByCar.
func (mr *MockINotificationPushServiceMockRecorder) NewReplaceByCar(carID, cusContractID, expoToken, toPhone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewReplaceByCar", reflect.TypeOf((*MockINotificationPushService)(nil).NewReplaceByCar), carID, cusContractID, expoToken, toPhone)
}

// NewReplaceByOtherCar mocks base method.
func (m *MockINotificationPushService) NewReplaceByOtherCar(carID int, expoToken, toPhone string) *PushMessage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewReplaceByOtherCar", carID, expoToken, toPhone)
	ret0, _ := ret[0].(*PushMessage)
	return ret0
}

// NewReplaceByOtherCar indicates an expected call of NewReplaceByOtherCar.
func (mr *MockINotificationPushServiceMockRecorder) NewReplaceByOtherCar(carID, expoToken, toPhone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewReplaceByOtherCar", reflect.TypeOf((*MockINotificationPushService)(nil).NewReplaceByOtherCar), carID, expoToken, toPhone)
}
